...
# Текущий dataset
Сейчас я обучаю модель на датасете `RAVDESS`([link](https://zenodo.org/record/1188976#.ZE6NGSPP2Un)).
...
Ниже пример полученной картинки из полученного обучающего набора данных:
