...
img_path = '/home/admin-gpu/Downloads/datasets/RAVDESS_frames_set/02-01-01-01-01-01-01_frame_1.png'
...
with mp_face_detection.FaceDetection(
    ...
    if results.detections:
        ...
        cv2.imwrite('tmp_crop.png', image[ymin:ymin+height, xmin:xmin+width])
